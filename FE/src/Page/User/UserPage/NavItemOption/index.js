        ...
        {isSticky ? (
          <div className={cx("nav-list")}>
            <div className={cx("headerFixed-person")}>
              ...
              <span>
                {fullNameUser &&
                  fullNameUser.first_name + " " + fullNameUser.last_name}
              </span>
            </div>
          </div>
        ) : (
          <div className={cx("nav-list")}>
            <Link
              ...
              className={cx("list-item", {
                "ative-item": "userPost" === typePage,
              })}
            >
              <span>Bài viết</span>
            </Link>
            <Link
              to={`/userIntroduce/${userId}`}
              className={cx("list-item", {
                "ative-item": "userIntroduce" === typePage,
              })}
            >
              <span>Giới thiệu</span>
            </Link>
            <Link
              to={`/userFriend/${userId}`}
              className={cx("list-item", {
                "ative-item": "userFriend" === typePage,
              })}
            >
              <span>Bạn bè</span>
            </Link>
